...
void First_win() {
	...
	text(330,700,"TRAFFIC LIGHT SYSTEM",1);
	text(390,660,"Using OpenGL",1);
	text(430,620,"Group member:",2);
	text(100,580,"SAJIB KOTAL AND  MD. ANRAG SARGIA SHOWRAV",1);
	...
	text(900,460,"Z -- press moving both",2);
	text(900,420,"x -- press stop moving both",2);
